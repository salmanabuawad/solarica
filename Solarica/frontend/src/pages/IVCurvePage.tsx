...
export function IVCurvePage() {
  ...
  const colDefs = useMemo<ColDef<ConnectorMeasurement>[]>(
    () => [
      ...
      { field: "moduleType",            headerName: "Module Type",               minWidth: 120, flex: 1,   filter: true },
      { field: "moduleReference",       headerName: "Module Ref.",               minWidth: 120, flex: 1,   filter: true },
      { field: "modulesSeries",         headerName: "Series",     width: 80,  filter: "agNumberColumnFilter" },
      { field: "modulesParallel",       headerName: "Parallel",   width: 80,  filter: "agNumberColumnFilter" },
      { field: "nominalPowerW",         headerName: "Pnom (W)",   width: 100, filter: "agNumberColumnFilter" },
      ...
      { field: "vpmaxV",                headerName: "Vpmax (V)",  width: 100, filter: "agNumberColumnFilter" },
      { field: "ipmaxA",                headerName: "Ipmax (A)",  width: 100, filter: "agNumberColumnFilter" },
      { field: "ffPercent",             headerName: "FF (%)",     width: 90,  filter: "agNumberColumnFilter" },
      { field: "rsOhm",                 headerName: "Rs (Ω)",     width: 90,  filter: "agNumberColumnFilter" },
      { field: "rpOhm",                 headerName: "Rp (Ω)",     width: 90,  filter: "agNumberColumnFilter" },
      { field: "irradianceWM2",         headerName: "Irr. (W/m²)",width: 110, filter: "agNumberColumnFilter" },
      { field: "sensorTempC",           headerName: "Sensor T (°C)",width: 110,filter: "agNumberColumnFilter" },
      { field: "moduleTempC",           headerName: "Module T (°C)",width: 110,filter: "agNumberColumnFilter" },
      { field: "sweepDurationMs",       headerName: "Sweep (ms)", width: 100, filter: "agNumberColumnFilter" },
      { field: "irradianceSensorType",  headerName: "Irr. Sensor",minWidth: 120, flex: 1, filter: true },
      { field: "irradianceSensorSerial",headerName: "Irr. S/N",   minWidth: 110, flex: 1, filter: true },
      { field: "importSource",          headerName: "Source",     minWidth: 110, flex: 1, filter: true },
      { field: "externalMeasurementKey",headerName: "Ext. Key",   minWidth: 130, flex: 1, filter: true },
      { field: "notes",                 headerName: "Notes",      minWidth: 150, flex: 2, filter: true },
      {
        field: "syncStatus",
