...
class MockDriver:
    """Simulates a connected PVPM 1540X device for dev and demo use."""
    ...
    def list_ports(self) -> list[dict]:
        return [
            {"name": "MOCK1", "description": "Mock PVPM device (port A)"},
            {"name": "MOCK2", "description": "Mock PVPM device (port B)"},
        ]
